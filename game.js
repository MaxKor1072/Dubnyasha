...
const presets = {
    ...
    newyear: {
        ...
        mainDescription: "Дубняша подготовила праздничные вопросы о новогодних традициях университета. Узнай, как в «Дубне» встречают Новый год и весело проведи время!",
        gameData: [
            {
